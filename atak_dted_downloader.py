...
def main() -> None:
    ...
    package_name = ask_package_name(default_package_name)
    if not package_name:
        log("Cancelled at package name prompt.")
        return
